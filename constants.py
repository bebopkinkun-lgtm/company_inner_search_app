...
SUPPORTED_EXTENSIONS = {
    ...
    ".txt": lambda path: TextLoader(path, encoding="utf-8") # 問題5 追加
}
...
# 参照元（ファイルパス／ページ番号）を必ず明示するよう指示を追加
# ドキュメントにページ番号のメタデータが含まれている場合は、
# 回答内で参照元を「ファイルパス (ページ N)」の形式で表示してください。
# 例: ./data/顧客/提案書.pdf (ページ 12)
